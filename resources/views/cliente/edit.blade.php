...
<div class="card">
    <div class="card-body">
        <form method="post" action="{{url('/clientes/'.$cliente->id)}}" novalidate >
            ...
            <input type="date"  name="fechaNac" value="{{$cliente->fechaNac}}" class="focus border-primary  form-control">
