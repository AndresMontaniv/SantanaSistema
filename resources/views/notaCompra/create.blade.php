...
<div class="container " style="background-color: white">
    <div class="row justify-content-center border rounded-top">
        <div class="col">
            ...
            <form method="post" action="{{url('/notaCompras')}}" novalidate >
                @csrf 
                <div class="row row justify-content-center"> 
                    <div class="col-1">
                        <input type="hidden"  name="compraId" value="{{$compra->id}}" class="focus border-primary  form-control" >
                    </div>                
                    <div class="col-4">
            ...
            <div class="row justify-content-end">
                <form action="{{url('/compras/'.$compra->id)}}" method="post">
                    ...
                    <a class="btn btn-success btn-sm m-2" href="{{url('/compras/')}}">Guardar cambios</a>
                  </form>
            </div>    
